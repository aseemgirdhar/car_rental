...
const Login = () => {
  ...
  <div className="container px-6 py-12 h-full m-auto">
    <div className="flex justify-center items-center flex-wrap h-full g-6 text-gray-800">
      ...
      <div className="md:w-8/12 lg:w-5/12 form-bg">
        <img src={LoginLogo} className='m-auto mb-6' />
        <form>
          {/* Email input */}
          <div className="mb-6">
          ...
          <div className="flex justify-between items-center mb-6">
            ...
            <a href="#!" className="text-gray-800 hover:text-bg focus:text-blue-700 active:text-blue-800 duration-200 transition ease-in-out">Forgot password?</a>
          </div>
          {/* Submit button */}
          <button type="submit" className="inline-block px-7 py-3 bg-bg text-textColor font-bold text-sm leading-snug uppercase rounded shadow-md hover:bg-cartNumBg hover:shadow-lg focus:bg-blue-700 focus:shadow-lg focus:outline-none focus:ring-0 active:bg-blue-800 active:shadow-lg transition duration-150 ease-in-out w-full" data-mdb-ripple="true" data-mdb-ripple-color="light">
            Sign in
          </button>
