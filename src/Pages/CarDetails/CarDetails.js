      ...
      <div className="bg-white">
        ...
        <div className="max-w-2xl mx-auto pt-10 pb-16 px-4 sm:px-6 lg:max-w-7xl lg:pt-16 lg:pb-24 lg:px-8 lg:grid lg:grid-cols-3 lg:grid-rows-[auto,auto,1fr] lg:gap-x-8">
          <div className="lg:col-span-2 lg:border-r lg:border-gray-200 lg:pr-8">
            <h1 className="text-2xl font-extrabold tracking-tight text-gray-900 sm:text-3xl">{getCarDetails.car_name}</h1>
          </div>

          {/* Options */}
          <div className="mt-4 lg:mt-0 lg:row-span-3">
            <h2 className="sr-only">Product information</h2>
            <p className="text-3xl text-gray-900 text-left flex items-center"> <CurrencyRupeeIcon className='w-6 h-6 mr-2' /> {getCarDetails.car_price_per_hour} /Hr</p>
            ...
            <form className="mt-10">
              {/* Colors */}
              <div>
                <h3 className="text-sm text-gray-900 font-medium text-left">Color</h3>
                  <div className="car_color" style={{background: `${getCarDetails.car_color}`}}> </div> 
              </div>

              {/* Sizes */}
              <div className="mt-10">
                <div className="flex items-center justify-between">
                  <h3 className="text-sm text-gray-900 font-medium">FREE benefits included with your rental</h3>
          ...
          <div className="py-10 lg:pt-6 lg:pb-16 lg:col-start-1 lg:col-span-2 lg:border-r lg:border-gray-200 lg:pr-8">
            ...
            <div className="mt-10">
              ...
              <div className="mt-4">
                <ul role="list" className="pl-4 list-disc text-sm space-y-2 car-detail-list">
                  <li className="text-gray-900 text-left flex justify-between"> 
                   <span className="text-cartNumBg"> Car Type </span> {getCarDetails.car_type}
                  </li>
                  <li className="text-gray-900 text-left flex justify-between"> 
                   <span className="text-cartNumBg"> Car Driven </span> {getCarDetails.car_driven}
                  </li>
                  <li className="text-gray-900 text-left flex justify-between"> 
                   <span className="text-cartNumBg"> Car Fuel Type </span> {getCarDetails.car_fuel_type}
                  </li>
                  <li className="text-gray-900 text-left flex justify-between"> 
                   <span className="text-cartNumBg"> Car Gear Type </span> {getCarDetails.car_gear_type}
                  </li>
                  <li className="text-gray-900 text-left flex justify-between"> 
                   <span className="text-cartNumBg"> Car Model </span> {getCarDetails.car_model}
                  </li>
                  <li className="text-gray-900 text-left flex justify-between"> 
                   <span className="text-cartNumBg"> Car Number </span> {getCarDetails.car_number}
                  </li>
                  <li className="text-gray-900 text-left flex justify-between"> 
                   <span className="text-cartNumBg"> Car Seats </span> {getCarDetails.car_seats}
                  </li>

                  <li className="text-gray-900 text-left flex justify-between"> 
                   <span className="text-cartNumBg"> Car Tyre Type </span> {getCarDetails.car_tyre_type}
                  </li>
